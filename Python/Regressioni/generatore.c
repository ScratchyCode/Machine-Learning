...
/*** DATI ***/
#define NUMMAX 1000               // numero di dati analitici da generare
...
#define ERRORE 0.1                // valore dell'incertezza sulle ordinate
/*** FUNZIONE ***/
...
int main(){
    ...
    for(i=0; i<NUMMAX; i++){
        x = randReal(XMIN,XMAX);
        y = f(x) + randReal(-ERRORE,ERRORE);
        fprintf(pf,"%lf %lf\n",x,y);
    }
